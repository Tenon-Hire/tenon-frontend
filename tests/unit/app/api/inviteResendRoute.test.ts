/**
 * Tests for /api/simulations/[id]/candidates/[candidateSessionId]/invite/resend route
 */
...
describe('/api/simulations/[id]/candidates/[candidateSessionId]/invite/resend route', () => {
  ...
  it('calls withRecruiterAuth with correct options', async () => {
    const mockResponse = { inviteEmailStatus: 'sent' };
