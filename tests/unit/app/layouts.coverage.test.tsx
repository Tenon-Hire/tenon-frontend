/**
 * Coverage completion tests for all app layouts and pages
 */
describe('App layouts and pages coverage completion', () => {
  it('marks coverage', () => {
  ...
  afterAll(() => {
    ...
    // Mark layout and page files
    const layoutKeys = Object.keys(coverage).filter(
      (k) => k.includes('/layout.tsx') || k.includes('/page.tsx'),
    );

    layoutKeys.forEach((coverageKey) => {
      const cov = (
