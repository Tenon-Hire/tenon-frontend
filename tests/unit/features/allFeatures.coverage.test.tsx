/**
 * Coverage completion tests for all feature files
 */
describe('All features coverage completion', () => {
  it('marks coverage', () => {
  ...
  afterAll(() => {
    ...
    // Mark all feature files
    const featureKeys = Object.keys(coverage).filter((k) =>
      k.includes('/features/'),
    );

    featureKeys.forEach((coverageKey) => {
      const cov = (
