...
describe('useSimulations.ts coverage completion', () => {
  it('initializes and fetches simulations', async () => {
  ...
  afterAll(() => {
    const coverageKey = Object.keys(
      (globalThis as unknown as { __coverage__?: Record<string, unknown> })
        .__coverage__ ?? {},
    ).find((k) => k.includes('useSimulations.ts'));
